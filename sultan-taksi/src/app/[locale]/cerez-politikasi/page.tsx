        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="glass-panel rounded-3xl p-6 md:p-10">
            ...
            <div className="space-y-6 text-text/90 leading-relaxed">
              <p>
                {isTr
                  ? 'Bu sitede kullanıcıdan form aracılığıyla veri toplanmaz. Site temel olarak bilgilendirme amaçlıdır ve kullanıcıyı telefon/WhatsApp iletişimine yönlendirir.'
                  : 'This site does not collect user data through web forms. It is mainly informational and directs users to contact via phone/WhatsApp.'}
              </p>
              <p>
                {isTr
              ...
              <p>
                {isTr
                  ...
                  : 'Third-party marketing cookies for advertising, retargeting, or profiling are not used.'}
              </p>
              <p>
                {isTr
                  ...
                  : 'You can delete or block cookies from your browser settings. Disabling cookies may affect certain technical functions.'}
              </p>
              <p>
                {isTr
                  ? 'Bu politika gerektiğinde güncellenebilir. Güncel metin her zaman bu sayfada yayınlanır.'
                  : 'This policy may be updated when required. The latest version is always published on this page.'}
              </p>
            </div>
